...
export const ContractHTMLPreview = ({
  ...
  return (
    <div className="bg-white p-8 shadow-sm mx-auto max-w-[800px] text-[#333] font-serif text-sm leading-relaxed printable-content">
      {/* Header */}
      <div className="text-center border-b border-[#333] pb-4 mb-8">
      ...
      <div className="space-y-4">
        <div>
          <h2 className="font-bold uppercase mb-1">CLÁUSULA PRIMEIRA - DO OBJETO</h2>
        ...
        <div>
          <h2 className="font-bold uppercase mb-1">CLÁUSULA QUINTA - DOS PRAZOS DE EXECUÇÃO</h2>
          <p className="text-justify">
        ...
        <div>
          <h2 className="font-bold uppercase mb-1">CLÁUSULA SEXTA - DAS TOLERÂNCIAS TÉCNICAS</h2>
          <p className="text-justify">
        ...
        <div>
          <h2 className="font-bold uppercase mb-1">CLÁUSULA SÉTIMA - DO PREÇO E DO PAGAMENTO</h2>
          <p className="text-justify">
        ...
        <div>
          <h2 className="font-bold uppercase mb-1">CLÁUSULA OITAVA - DAS GARANTIAS</h2>
          <p className="text-justify">
        ...
        <div>
          <h2 className="font-bold uppercase mb-1">CLÁUSULA DÉCIMA SEXTA - DAS COMUNICAÇÕES</h2>
          <p className="text-justify">
        ...
        <div>
          <h2 className="font-bold uppercase mb-1">CLÁUSULA DÉCIMA NONA - DO FORO</h2>
          <p className="text-justify">
      ...
      <div className="mt-16 grid grid-cols-2 gap-12">
        <div className="text-center">
          <div className="border-t border-[#333] pt-2">
            ...
            <p className="font-bold">{loja?.nome || "DIAS & DIAS"}</p>
          </div>
        </div>
        <div className="text-center">
          <div className="border-t border-[#333] pt-2">
            <p className="text-xs uppercase">CONTRATANTE</p>
            <p className="font-bold">{contrato.cliente_nome}</p>
          </div>
        </div>
        <div className="text-center mt-8">
          <div className="border-t border-[#333] pt-2">
            <p className="text-xs uppercase">Testemunha 1</p>
            <p className="text-xs">CPF:</p>
          </div>
        </div>
        <div className="text-center mt-8">
          <div className="border-t border-[#333] pt-2">
            <p className="text-xs uppercase">Testemunha 2</p>
            <p className="text-xs">CPF:</p>
          </div>
        </div>
      </div>
      ...
      {/* Quadro Resumo */}
      <div className="mt-24 pt-8 border-t border-dashed border-gray-300">
        <div className="text-center mb-6">
          <h2 className="text-lg font-bold uppercase">QUADRO RESUMO DO CONTRATO</h2>
        </div>
        ...
        <div className="border border-[#333]">
          {[
            ...
            <div
              key={idx}
              className={`flex border-b border-[#333] last:border-0 ${
                idx % 2 === 0 ? "bg-gray-50" : "bg-white"
              }`}
            >
              <div className="w-1/3 p-2 font-bold border-r border-[#333] text-xs">
                {row.label}:
              </div>
              <div className="w-2/3 p-2 text-xs">{row.value}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {contrato.assinado && (
        <div className="mt-12 p-4 border-2 border-green-600 rounded bg-green-50 text-green-800">
          <p className="font-bold text-center mb-2">✓ DOCUMENTO ASSINADO DIGITALMENTE</p>
          <div className="text-xs space-y-1">
            <p>Assinado por: {contrato.assinatura_nome}</p>
            <p>Data/hora: {new Date(contrato.data_assinatura).toLocaleString("pt-BR")}</p>
            <p>IP: {contrato.assinatura_ip}</p>
            <p>Hash: {contrato.assinatura_hash?.slice(0, 16)}</p>
          </div>
        </div>
      )}
