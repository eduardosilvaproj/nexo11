// Conteúdo do Guia Técnico - placeholder
// O conteúdo completo deve ser restaurado do repositório GitHub

export const GUIA_TECNICO_CONTENT = `GUIA TÉCNICO - GRUPO DIAS

INFORMAÇÕES TÉCNICAS PRINCIPAIS:

FERRAGENS:
- Corrediça padrão: 40kg por par (inclui gaveta, ferragem e itens armazenados)
...
GAVETAS COZINHA:
- Largura mínima: 20cm
- Largura máxima: 120cm
- Profundidade máxima: 50cm

COZINHA:
- Torre quente: 70cm de armário, tomadas fora da torre
- Altura pedra cozinha: 95cm do chão
- Regra do triângulo: pia, fogão e geladeira em pontas de um triângulo imaginário
...
CHECKLIST DE CONFERÊNCIA (11 itens):
1. Implantação fábrica
2. Ferragens
3. Confirmação cliente
4. Prints
5. Hidráulico
6. Elétrico/LED
7. Planta base
