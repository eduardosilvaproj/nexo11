  ...
  return (
    <section className="relative py-24 sm:py-40 px-4 sm:px-6 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] max-w-[500px] max-h-[500px] rounded-full bg-[#12B76A]/10 blur-[100px] sm:blur-[140px]" />
      </div>
