  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 font-inter">Indicadores Operacionais</h2>
          <p className="text-sm text-slate-500 font-inter">Métricas reais de execução, prazos e qualidade.</p>
        </div>
      </div>
