  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Análise inteligente de projetos PDF para estimativa rápida de preços</p>
      </div>
      ...
      {!relatorio ? (
        ...
        <div className="space-y-4">
          <button onClick={() => setRelatorio(null)} className="text-sm text-primary hover:underline">
            ← Nova análise
          </button>
